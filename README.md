...
Open-source x402 + MPP client for AI agents. Multi-chain. Zero custody. 1779+ public API registry across 53 categories included.
...
| Manual API discovery | 1779+ API registry built-in |
| No free API support | 739 free APIs (no key, no payment needed) |
